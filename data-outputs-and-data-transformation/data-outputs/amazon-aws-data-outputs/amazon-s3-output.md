---
description: >-
  This article provides an introduction to Amazon S3 along with a guide on
  creating an Amazon S3 data output using Upsolver.
---
...
2. Select **Amazon S3** as your output type.
...
* **Output Format**
* **S3 connection:** [How to create an Amazon S3 connection](../../../administration/connections/#amazon-s3)
...
{% hint style="success" %}
To easily navigate to your output, click **Properties** then **View output in AWS S3 Console**, which will take you to the outputs folder in your S3 storage bucket.
{% endhint %}
