---
description: >-
  This article provides an introduction to Microsoft Azure Storage along with a
  guide on how to create a Microsoft Azure Storage data output using Upsolver.
---
...
* **Output Format**
* **Microsoft Azure connection:** [How to create an Azure Blob Storage connection](../../administration/connections/azure-blob-storage-connection.md)
