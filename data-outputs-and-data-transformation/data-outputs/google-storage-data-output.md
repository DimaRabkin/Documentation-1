---
description: >-
  This article provides an introduction to Google Storage along with a guide on
  how to create a Google Storage data output using Upsolver.
---
...
## Create a Google Storage data output

1. Go to the **Outputs** page and click **New**.

2. Select **Google Storage** as your output type.
...
* **Output Format**
* **Google Storage connection:** [How to create a Google Storage connection](../../administration/connections/#how-to-create-a-google-storage-connection)
...
{% hint style="success" %}
To easily navigate to your output, click **Properties** then **View output in Google Storage Console**, which will take you to the outputs folder in your Google Storage bucket.
{% endhint %}
