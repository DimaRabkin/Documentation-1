---
description: >-
  This article provides an introduction to Apache Kafka along with a guide on
  how to create a Kafka data output using Upsovler.
---
...
* **Kafka Hosts:** [How to connect to Kafka](../../administration/connections/kafka-connection.md)
* **Topic Name**
